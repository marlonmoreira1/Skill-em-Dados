...
with coluna4.container(border=True):    
    ...
    make_bar(soft_skills,'soft_skills','Soft Skills mais Demandas para Profissionais de Dados',4,12,11,20)
...
with coluna5.container(border=True):
    ...
    make_bar_with_no_slice(metodologia_trabalho,'metodologia_trabalho','Principais Metodologias Ágeis em Dados',13,14,18)
