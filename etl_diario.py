...
analista_dados = get_dados("analise de dados", analista_dados_key_api)
analista_bi = get_dados("business intelligence", analista_bi_key_api)
cientista_dados = get_dados("ciencia de dados", cientista_dados_key_api)
engenheiro_dados = get_dados("engenharia de dados", engenheiro_dados_key_api)    
