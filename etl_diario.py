...
cargos = ["dados", "data", "front-end", "back-end"]

api_keys = {
    "dados": analista_dados_key_api,
    "data": analista_bi_key_api,
    "front-end": cientista_dados_key_api,
    "back-end": engenheiro_dados_key_api
}
