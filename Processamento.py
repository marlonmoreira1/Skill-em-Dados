...
def padronizar_cargo(linha):
    ...
    if (linha['cargo'].lower() == 'analista de dados' or pd.isna(linha['cargo'])) and ("data scientist" in linha['new_title'].lower() or "cientista de dados" in linha['new_title'].lower() or "cientista" in linha['new_title'].lower() or "ciência" in linha['new_title'].lower() or "science" in linha['new_title'].lower()):
        return 'Cientista de Dados'
    if (linha['cargo'].lower() == 'analista de dados' or pd.isna(linha['cargo'])) and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower() or "analytics" in linha['new_title'].lower()):
        return 'Analista de Dados'
    if (linha['cargo'].lower() == 'analista de bi' or pd.isna(linha['cargo'])) and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower() or "analytics" in linha['new_title'].lower()):
        return 'Analista de Dados'
    if (linha['cargo'].lower() == 'analista de bi' or pd.isna(linha['cargo'])) and ("engenheira de dados" in linha['new_title'].lower() or "engenheiro de dados" in linha['new_title'].lower() or "data engineer" in linha['new_title'].lower() or "engenharia" in linha['new_title'].lower() or "engenheiro dados" in linha['new_title'].lower() or "engenheiro (a) de dados" in linha['new_title'].lower() or "engenheiro" in linha['new_title'].lower()):
        return 'Engenheiro de Dados'
    if (linha['cargo'].lower() == 'analista de bi' or pd.isna(linha['cargo'])) and ("data scientist" in linha['new_title'].lower() or "cientista de dados" in linha['new_title'].lower() or "cientista" in linha['new_title'].lower() or "ciência" in linha['new_title'].lower() or "science" in linha['new_title'].lower()):
        return 'Cientista de Dados'
    if (linha['cargo'].lower() == 'analista de bi' or pd.isna(linha['cargo'])) and ("analista business intelligence" in linha['new_title'].lower() or "analista inteligência mercado" in linha['new_title'].lower() or "analista de bi" in linha['new_title'].lower() or "bi" in  linha['new_title'].lower() or "analista de business intelligence" in linha['new_title'].lower() or "power bi" in linha['new_title'].lower() or "especialista bi" in linha['new_title'].lower() or "inteligência mercado" in linha['new_title'].lower() or "negócios" in linha['new_title'].lower()):
        return 'Analista de BI'
    if (linha['cargo'].lower() == 'cientista de dados' or pd.isna(linha['cargo'])) and ("analista business intelligence" in linha['new_title'].lower() or "analista de inteligência de mercado" in linha['new_title'].lower() or "analista de bi" in linha['new_title'].lower() or "bi" in  linha['new_title'].lower() or "analista de business intelligence" in linha['new_title'].lower() or "power bi" in linha['new_title'].lower() or "especialista bi" in linha['new_title'].lower() or "inteligência mercado" in linha['new_title'].lower() or "negócios" in linha['new_title'].lower()):
        return 'Analista de BI'
    if (linha['cargo'].lower() == 'cientista de dados' or pd.isna(linha['cargo'])) and ("engenheira de dados" in linha['new_title'].lower() or "engenheiro de dados" in linha['new_title'].lower() or "data engineer" in linha['new_title'].lower() or "engenharia" in linha['new_title'].lower() or "engenheiro dados" in linha['new_title'].lower() or "engenheiro (a) de dados" in linha['new_title'].lower() or "engenheiro" in linha['new_title'].lower()):
        return 'Engenheiro de Dados'
    if (linha['cargo'].lower() == 'cientista de dados' or pd.isna(linha['cargo'])) and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower() or "analytics" in linha['new_title'].lower()):
        return 'Analista de Dados'
    if (linha['cargo'].lower() == 'cientista de dados' or pd.isna(linha['cargo'])) and ("data scientist" in linha['new_title'].lower() or "cientista de dados" in linha['new_title'].lower() or "cientista" in linha['new_title'].lower() or "ciência" in linha['new_title'].lower() or "science" in linha['new_title'].lower()):
        return 'Cientista de Dados'
    if (linha['cargo'].lower() == 'engenheiro de dados' or pd.isna(linha['cargo'])) and ("analista business intelligence" in linha['new_title'].lower() or "analista de inteligência de mercado" in linha['new_title'].lower() or "analista de bi" in linha['new_title'].lower() or "bi" in  linha['new_title'].lower() or "analista de business intelligence" in linha['new_title'].lower() or "power bi" in linha['new_title'].lower() or "especialista bi" in linha['new_title'].lower() or "inteligência mercado" in linha['new_title'].lower() or "negócios" in linha['new_title'].lower()):
        return 'Analista de BI'
    if (linha['cargo'].lower() == 'engenheiro de dados' or pd.isna(linha['cargo'])) and ("data scientist" in linha['new_title'].lower() or "cientista de dados" in linha['new_title'].lower() or "cientista" in linha['new_title'].lower() or "ciência" in linha['new_title'].lower() or "science" in linha['new_title'].lower()):
        return 'Cientista de Dados'
    if (linha['cargo'].lower() == 'engenheiro de dados' or pd.isna(linha['cargo'])) and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower() or "analytics" in linha['new_title'].lower()):
        return 'Analista de Dados'
    if (linha['cargo'].lower() == 'engenheiro de dados' or pd.isna(linha['cargo'])) and ("engenheira de dados" in linha['new_title'].lower() or "engenheiro de dados" in linha['new_title'].lower() or "data engineer" in linha['new_title'].lower() or "engenharia" in linha['new_title'].lower()or "engenheiro dados" in linha['new_title'].lower() or "engenheiro (a) de dados" in linha['new_title'].lower() or "engenheiro" in linha['new_title'].lower()):
