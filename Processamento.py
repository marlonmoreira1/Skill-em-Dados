...
def padronizar_cargo(linha):
    ...
    if linha['cargo'].lower() == 'analista de dados' and ("engenheira de dados" in linha['new_title'].lower() or "engenheiro de dados" in linha['new_title'].lower() or "data engineer" in linha['new_title'].lower() or "engenharia" in linha['new_title'].lower() or "engenheiro dados" in linha['new_title'].lower() or "engenheiro (a) de dados" in linha['new_title'].lower()):
    ...
    if linha['cargo'].lower() == 'analista de dados' and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower()):
        return 'Analista de Dados'
    if linha['cargo'].lower() == 'analista de bi' and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower()):
        return 'Analista de Dados'
    ...
    if linha['cargo'].lower() == 'cientista de dados' and ("engenheira de dados" in linha['new_title'].lower() or "engenheiro de dados" in linha['new_title'].lower() or "data engineer" in linha['new_title'].lower() or "engenharia" in linha['new_title'].lower() or "engenheiro dados" in linha['new_title'].lower() or "engenheiro (a) de dados" in linha['new_title'].lower()):
        return 'Engenheiro de Dados'
    if linha['cargo'].lower() == 'cientista de dados' and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower()):
        return 'Analista de Dados'
    if linha['cargo'].lower() == 'cientista de dados' and ("data scientist" in linha['new_title'].lower() or "cientista de dados" in linha['new_title'].lower()):
        return 'Cientista de Dados'
    ...
    if linha['cargo'].lower() == 'engenheiro de dados' and ("data scientist" in linha['new_title'].lower() or "cientista de dados" in linha['new_title'].lower()):
        return 'Cientista de Dados'
    if linha['cargo'].lower() == 'engenheiro de dados' and ("data analyst" in linha['new_title'].lower() or "analista de dados" in linha['new_title'].lower() or "assistente de dados" in linha['new_title'].lower() or "assistente dados" in linha['new_title'].lower() or "analista dados" in linha['new_title'].lower() or "inteligência de dados" in linha['new_title'].lower() or "comercial" in linha['new_title'].lower()):
        return 'Analista de Dados'
